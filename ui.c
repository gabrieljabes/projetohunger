...
void exibir_tela_titulo() {
    ...
    printf(" _   _                               _____                           \n");
    printf("| | | |                             |  __ \\                          \n");
    printf("| |_| |_   _ _ __   __ _  ___ _ __  | |  \\/ __ _ _ __ ___   ___  ___ \n");
    printf("|  _  | | | | '_ \\ / _` |/ _ \\ '__| | | __ / _` | '_ ` _ \\ / _ \\ __|\n");
    printf("| | | | |_| | | | | (_| |  __/ |    | |_\\ \\ (_| | | | | | |  __/\\__ \\ \n");
    printf("\\_| |_/\\__,_|_| |_|\\__, |\\___|_|     \\____/\\__,_|_| |_| |_|\\___||___/\n");
    printf("                    __/ |                                            \n");
    printf("                   |___/                                             \n");
...
void display_art(const char* art_name) {
    ...
    printf("______                    _              \n");
    printf("|  _  \\                  | |             \n");
    printf("| | | |___ _ __ _ __ ___ | |_ __ _       \n");
    printf("| | | / _ \\ '__| '__/ _ \\| __/ _` |      \n");
    printf("| |/ /  __/ |  | | | (_) | || (_| |_ _ _ \n");
    printf("|___/ \\___|_|  |_|  \\___/ \\__\\__,_(_|_|_)\n");
    printf("                                         \n");
    printf("                                         \n");
    }
    printf("\n");
